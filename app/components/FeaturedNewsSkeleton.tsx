...
interface FeaturedNewsSkeletonCardProps {
  variant: "big" | "wide" | "small";
  styles?: string;
}

const FeaturedNewsSkeletonCard: FC<FeaturedNewsSkeletonCardProps> = ({ variant, styles }) => {
...
export default FeaturedNewsSkeletonCard;
